import { __spreadArray, __rest, __assign } from 'tslib';
...
var useDrag = function useDrag(_a) {
  ...
  var handleTouchStartTimerRef = React.useRef(undefined);
  ...
  var isFirstMoveRef = React.useRef(false);
...
var SortableListContext = React.createContext(undefined);
var SortableList = function SortableList(_a) {
  ...
  var children = _a.children,
    ...
    rest = __rest(_a, ["children", "allowDrag", "onSortStart", "onSortMove", "onSortEnd", "draggedItemClassName", "as", "lockAxis", "customHolderRef", "dropTarget", "autoScroll"]);
  ...
  var itemsRect = React.useRef([]);
  // Hold all registered knobs
  var knobs = React.useRef([]);
  ...
  var sourceIndexRef = React.useRef(undefined);
  ...
  var initialScrollRef = React.useRef({
    x: 0,
    y: 0
  });
  // auto scroll method
  var autoScrolling = React.useCallback(function () {
  ...
  return React.createElement(as || DEFAULT_CONTAINER_TAG, __assign(__assign(__assign({}, allowDrag ? listeners : {}), rest), {
    ref: containerRef
  }), React.createElement(SortableListContext.Provider, {
    value: context
...
export { SortableItem, SortableKnob, SortableList as default };
