        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm text-[#374151] dark:text-slate-200">{detail?.title || "-"}</div>
            </div>
            <div className="space-y-2">
            ...
            {docs.length > 0 ? (
              <div className="space-y-3">
                <div className="text-base font-semibold text-[#0F0F0F] dark:text-slate-100">Attachments</div>
                <div className="space-y-2">
                  {docs.map((doc) => (
                    <DocumentItem
                      key={doc.id}
  ...
  return (
    <TabsContent value="ncr-log" className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl border border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-5 flex items-center justify-between">
          <div className="space-y-2">
            <div className="text-sm text-[#6B6B6B] dark:text-slate-400">All NCR</div>
            <div className="text-base font-semibold leading-8 text-[#0F0F0F] dark:text-slate-100">
        ...
        <div className="rounded-xl border border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-5 flex items-center justify-between">
          <div className="space-y-2">
            <div className="text-sm text-[#6B6B6B] dark:text-slate-400">Issued</div>
            <div className="text-base font-semibold leading-8 text-[#0F0F0F] dark:text-slate-100">
        ...
        <div className="rounded-xl border border-[#E5E7EB] dark:border-slate-800 bg-white dark:bg-slate-900 px-6 py-5 flex items-center justify-between">
          <div className="space-y-2">
            <div className="text-sm text-[#6B6B6B] dark:text-slate-400">Received</div>
            <div className="text-base font-semibold leading-8 text-[#0F0F0F] dark:text-slate-100">
      ...
      <DataTable<NcrRow>
        ...
        header={() => (
          <div className="flex items-center gap-4 border-b border-[#E9E9EB] px-6 py-4">
            <div className="text-base font-semibold text-[#0F0F0F] dark:text-slate-100">NCR</div>
