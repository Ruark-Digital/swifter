...
describe("Compliance & Security", () => {
  ...
  it("shows per-item approve/reject bar for contract security when canApprove", async () => {
    const actual = await vi.importActual<
      typeof import("../components/ComplianceDetailsSheet")
    >("../components/ComplianceDetailsSheet");
    const ComplianceDetailsSheet = actual.default;
  ...
  it("hides per-item approve bar when canApprove is false", async () => {
    const actual = await vi.importActual<
      typeof import("../components/ComplianceDetailsSheet")
    >("../components/ComplianceDetailsSheet");
    const ComplianceDetailsSheet = actual.default;
          ...
          data={
            {
              ...
              dueDate: "2026-06-01T00:00:00.000Z",
              status: "submitted",
              files: [{ name: "bond.pdf", url: "http://example.com/bond.pdf", type: "pdf", size: "1 KB" }],
            } as any
          }
        />
      </QueryClientProvider>,
